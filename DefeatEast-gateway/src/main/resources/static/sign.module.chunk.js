 ...
 * \@stable
 */
var VERSION = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["_8" /* Version */]('5.2.11');
...
module.exports = "<div class=\"top\">这里有个logo</div>\n<div class=\"y_regist_model\">\n    <div class=\"center\">\n        <form class=\"form-horizontal\" role=\"form\">\n            <div class=\"form-group\">\n                <div class=\"col-sm-12 form-header\">\n                    <h2>用户注册</h2>\n                </div>\n            </div>\n            <div class=\"form-group\">\n                <div class=\"col-sm-12\">\n                    <input type=\"text\" class=\"form-control\" name=\"phone\" placeholder=\" 请输入手机号码\" [(ngModel)]=\"phone\" (keyup)=\"inphone($event)\">\n                    <span class=\"error\">{{errorPhone}}</span>\n                </div>\n            </div>\n\n            <div class=\"form-group\">\n                <div class=\"input-group\">\n                    <input type=\"text\" class=\"form-control\" name=\"code\" placeholder=\" 短信验证码\" [(ngModel)]=\"code\" (keyup)=\"incode($event)\">\n                    <span class=\"input-group-addon\" style=\"height: 100%;\">\n                        <button type=\"button\" class=\"btn btn-info\" (click)=\"send()\">获取验证码</button>\n                    </span>\n                </div>\n                <span class=\"error code-error\">{{errorCode}}</span>\n            </div>\n\n            <div class=\"form-group\">\n                <div class=\"col-sm-12\">\n                    <input type=\"text\" class=\"form-control\" name=\"psw\" placeholder=\" 请输入密码\" [(ngModel)]=\"psw\" (keyup)=\"inpsw($event)\">\n                    <span class=\"error\">{{errorPsw}}</span>\n                </div>\n            </div>\n\n            <div class=\"form-group\">\n                <div class=\"col-sm-12\">\n                    <input type=\"text\" class=\"form-control\" name=\"rePsw\" placeholder=\" 确认密码\" [(ngModel)]=\"rePsw\" (keyup)=\"inrepsw($event)\">\n                    <span class=\"error\">{{errorRePsw}}</span>\n                </div>\n            </div>\n\n            <div class=\"form-group\">\n                <div class=\"col-sm-12\">\n                    <button type=\"button\" class=\"btn btn-info sign-btn\" (click)=\"sign()\">立即注册</button>\n                </div>\n            </div>\n        </form>\n    </div>\n</div>\n<div class=\"bottom\">这里写点啥</div>\n<!--背景小图标 -->\n<div class=\"r_icon1\"></div>\n<div class=\"r_icon2\"></div>\n<div class=\"r_icon3\"></div>\n<div class=\"r_icon4\"></div>\n<div class=\"r_icon5\"></div>"
...
var SignComponent = /** @class */ (function () {
    ...
    ///**10002, "系统错误" 10008, "获取验证码频繁" 10005, "手机号错误"*/
    SignComponent.prototype.send = function () {
        if (this.phone == null || this.phone == '') {
            this.errorPhone = '手机号码不正确';
            return;
        }
        var uri = 'data.json';
        this.http.get(uri).then(function (data) {
            if (data.errno !== 10000) {
                alert(data.msg);
                return;
            }
    ...
    SignComponent.prototype.sign = function () {
        ...
        if (this.rePsw == null || this.rePsw == '') {
            this.errorRePsw = '在次输入密码不正确';
            return;
        }
        if (this.psw !== this.rePsw) {
            this.errorRePsw = '2次密码不相同';
            return;
        }
        var uri = 'data.1.json';
        this.http.get(uri).then(function (data) {
    ...
    SignComponent.prototype.inphone = function (event) {
        this.errorPhone = '';
        this.phone = event.target.value;
    };
    SignComponent.prototype.inpsw = function (event) {
        this.errorPsw = '';
        this.psw = event.target.value;
    };
    SignComponent.prototype.inrepsw = function (event) {
        this.errorRePsw = '';
        this.rePsw = event.target.value;
    };
    SignComponent.prototype.incode = function (event) {
        this.errorCode = '';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sign_component__ = __webpack_require__("./src/app/sign/sign.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sign_routes__ = __webpack_require__("./src/app/sign/sign.routes.ts");
...
var SignModule = /** @class */ (function () {
    ...
    SignModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__sign_component__["a" /* SignComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["b" /* CommonModule */],
                __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormsModule */],
                __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* RouterModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__sign_routes__["a" /* SignRoutes */])
            ],
            providers: []
        })
    ], SignModule);
...
/***/ "./src/app/sign/sign.routes.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SignRoutes; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sign_component__ = __webpack_require__("./src/app/sign/sign.component.ts");

var SignRoutes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_0__sign_component__["a" /* SignComponent */] }
];
